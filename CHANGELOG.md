...
- Better drone filtering in the challenge league section.
...
- Added all new items and removed what was needed according to the [forum post](https://www.pathofexile.com/forum/view-thread/3230194).
- Added all new divination cards and updated the list of good cards.

## 3.16.1

- Improved highlights for Blueprints.
- Separated Normal and Magic 3-4 links for leveling.

## 3.16.0e

- Added advanced filter (Racing tab) for racing armor socket color to filter bases easily as you progress.

## 3.16.0d

- Updated the racing filter for normal and magic armour except shields.
...
- Fixed ward items.
- Changed highlighting for Grand Artifacts.
